...
const messages = {
  fr: {
    ...
    postsCountLabel: "repères",
    readMore: "Lire",
    viewPhotoLink: "Voir la photo",
    sameDay: "Même jour",
    day_one: "jour",
    day_other: "jours",
    approxKm: "environ",
    estimatedDistance: "Distance estimée",
    estimatedTripDistance: "Distance estimée",
    estimatedLegDistance: "Distance estimée",
  ...
  en: {
    ...
    postsCountLabel: "pins",
    readMore: "Read",
    viewPhotoLink: "View photo",
    sameDay: "Same day",
    day_one: "day",
    day_other: "days",
    approxKm: "approx.",
    estimatedDistance: "Estimated Distance",
    estimatedTripDistance: "Estimated distance",
    estimatedLegDistance: "Estimated distance",

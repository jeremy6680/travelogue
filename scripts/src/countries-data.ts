export const COUNTRY_CODES: { code: string; name: string }[] = [
  ...
  { code: "HK", name: "Hong Kong" }, { code: "HN", name: "Honduras" }, { code: "HU", name: "Hungary" }, { code: "IS", name: "Iceland" },
  ...
  { code: "MN", name: "Mongolia" }, { code: "MO", name: "Macao" }, { code: "ME", name: "Montenegro" }, { code: "MA", name: "Morocco" },
  ...
  { code: "VA", name: "Vatican City" }, { code: "VU", name: "Vanuatu" }, { code: "VE", name: "Venezuela" }, { code: "VN", name: "Vietnam" },
  { code: "XE", name: "England" }, { code: "XS", name: "Scotland" }, { code: "XW", name: "Wales" },
